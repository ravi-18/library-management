    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookReservation_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BorrowTransactionItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BorrowTransactionItems_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BorrowTransactionItems_BorrowTransactions_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowTransactionItems_BookId",
                table: "BorrowTransactionItems",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BorrowTransactionItems_TransactionId",
                table: "BorrowTransactionItems",
